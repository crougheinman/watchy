...
// Metadata comes from the official TMDB API (api.themoviedb.org), which needs a
// free API key in VITE_TMDB_API_KEY. (The old db.videasy.net proxy was shut
// down — its DNS no longer resolves — so we use TMDB directly.)
export const TMDB_API_BASE = import.meta.env.VITE_TMDB_API_BASE   || 'https://api.themoviedb.org/3';
